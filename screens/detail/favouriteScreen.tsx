...
const FavouriteScreen = ({navigation}: any) => {
    ...
    return (
        <ScrollView style={{backgroundColor: 'black'}}>
            ...
            <View>
                <View >
                    <Image style={styles.favouriteImage} source={{uri: 'https://www.themealdb.com/images/ingredients/Salmon.png'}}/>
                    <Text style={styles.favouriteTitle}>Favourite list</Text>
                </View>
                {isLoading ? <Waiting/> : (
                    <FlatList
                        data={products}
